...
namespace PruebaNET_SantiagoPineda.Seeders
{
    public class RoomSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            new Room { Id = 2, RoomNumber = "102", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }, // Suite
            ...
            new Room { Id = 6, RoomNumber = "106", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }, // Suite
            ...
            new Room { Id = 9, RoomNumber = "109", PricePerNight = 50, Availability = true, MaxOccupancyPerson = 1, RoomTypeId = 1 },  // Single Room
            new Room { Id = 10, RoomNumber = "110", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }, // Suite

            // Rooms 201-210 with mixed RoomTypeId
            new Room { Id = 11, RoomNumber = "201", PricePerNight = 200, Availability = true, MaxOccupancyPerson = 4, RoomTypeId = 4 }, // Family Room
            new Room { Id = 12, RoomNumber = "202", PricePerNight = 80, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 2 },  // Double Room
            ...
            new Room { Id = 17, RoomNumber = "207", PricePerNight = 50, Availability = true, MaxOccupancyPerson = 1, RoomTypeId = 1 },  // Single Room
            new Room { Id = 18, RoomNumber = "208", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }, // Suite
            new Room { Id = 19, RoomNumber = "209", PricePerNight = 200, Availability = true, MaxOccupancyPerson = 4, RoomTypeId = 4 }, // Family Room
            new Room { Id = 20, RoomNumber = "210", PricePerNight = 80, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 2 },  // Double Room

            // Rooms 301-310 with mixed RoomTypeId
            new Room { Id = 21, RoomNumber = "301", PricePerNight = 50, Availability = true, MaxOccupancyPerson = 1, RoomTypeId = 1 },  // Single Room
            new Room { Id = 22, RoomNumber = "302", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }, // Suite
            ...
            new Room { Id = 27, RoomNumber = "307", PricePerNight = 80, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 2 },  // Double Room
            ...
            // Rooms 401-410 with mixed RoomTypeId
            new Room { Id = 31, RoomNumber = "401", PricePerNight = 80, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 2 },  // Double Room
            new Room { Id = 32, RoomNumber = "402", PricePerNight = 200, Availability = true, MaxOccupancyPerson = 4, RoomTypeId = 4 }, // Family Room
            ...
            new Room { Id = 38, RoomNumber = "408", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }, // Suite
            ...
            new Room { Id = 41, RoomNumber = "501", PricePerNight = 50, Availability = true, MaxOccupancyPerson = 1, RoomTypeId = 1 },  // Single Room
            ...
            new Room { Id = 44, RoomNumber = "504", PricePerNight = 200, Availability = true, MaxOccupancyPerson = 4, RoomTypeId = 4 }, // Family Room
            new Room { Id = 45, RoomNumber = "505", PricePerNight = 50, Availability = true, MaxOccupancyPerson = 1, RoomTypeId = 1 },  // Single Room
            new Room { Id = 46, RoomNumber = "506", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }, // Suite
            new Room { Id = 47, RoomNumber = "507", PricePerNight = 80, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 2 },  // Double Room
            ...
            new Room { Id = 50, RoomNumber = "510", PricePerNight = 150, Availability = true, MaxOccupancyPerson = 2, RoomTypeId = 3 }  // Suite
        );
    }
    }
}